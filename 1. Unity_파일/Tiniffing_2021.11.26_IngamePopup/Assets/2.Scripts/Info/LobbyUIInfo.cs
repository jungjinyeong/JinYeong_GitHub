...
public class LobbyUIInfo : MonoBehaviour
{
    ...
    public void Init()
   {
    ...
    private void HandEffect()
    {
        ...
        handRectTr.DORotate(new Vector3(0, 180, 20), 0.35f).SetEase(Ease.InQuad).SetLoops(-1, LoopType.Yoyo);
    }
    public void TeeniepingMindMaskOn()
    {
        teeniepingMindMaskSpeechBubbleText.text = DataService.Instance.GetText(606);
