...
namespace SqlCipher4Unity3D
{
    ...
    public class SQLiteConnection : IDisposable
    {
        ...
        /// <summary>
        ///     Sets a busy handler to sleep the specified amount of progressTime when a table is locked.
        ///     The handler will sleep multiple times until a total progressTime of <see cref="BusyTimeout" /> has accumulated.
        /// </summary>
    ...
    public class SQLiteCommand
    {
        ...
        /// <summary>
        ///     Invoked every progressTime an instance is loaded from the database.
        /// </summary>
        /// <param name='obj'>
