...
public class InGameManager : MonoBehaviour
{
    ...
    IEnumerator EffectDisplayCoroutine()
    {
        ...
        yield return YieldInstructionCache.WaitForSeconds(5.001f);
        ReadyEffectOn();
    ...
    {
        Instantiate(Resources.Load<GameObject>("Prefabs/InGameEffect/InGameMissionPreview"), canvasTr).GetComponent<InGameMissionPreview>().Init();
    }
