...
public class HeartStorePopup : BasePopup
{
    ...
    private void HeartTextRefresh()
    {
        ...
        string[] heartPriceArr = baseDetailTableData.Split(':');

        heart_ad_text.text = string.Format("{0} {1}{2}", DataService.Instance.GetText(28), heartPriceArr[0], DataService.Instance.GetText(29));
        ad_priceTag_text.text = DataService.Instance.GetText(30);
        heart1_text.text = string.Format("{0} {1}{2}", DataService.Instance.GetText(28), heartPriceArr[1], DataService.Instance.GetText(29));
        heart2_text.text = string.Format("{0} {1}{2}", DataService.Instance.GetText(28), heartPriceArr[2], DataService.Instance.GetText(29));
        heart3_text.text = string.Format("{0} {1}{2}", DataService.Instance.GetText(28), heartPriceArr[3], DataService.Instance.GetText(29));
        heart4_text.text = string.Format("{0} {1}{2}", DataService.Instance.GetText(28), heartPriceArr[4], DataService.Instance.GetText(29));
        heart5_text.text = string.Format("{0} {1}{2}", DataService.Instance.GetText(28), heartPriceArr[5], DataService.Instance.GetText(29));
    }
    private void TextRefresh()
    {
        HeartTextRefresh();
        titleText.text = DataService.Instance.GetText(35);  
        speechBubbleText.text = DataService.Instance.GetText(33);
