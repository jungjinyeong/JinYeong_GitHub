...
public class GoldStorePopup : BasePopup
{
    ...
    private void TextRefresh()
    {
        ...
        speechBubbleText.text = DataService.Instance.GetText(38);
        ...
        gold1PriceText.text = DataService.Instance.GetText(39);
        gold2PriceText.text = DataService.Instance.GetText(40);
        gold3PriceText.text = DataService.Instance.GetText(41);
        gold4PriceText.text = DataService.Instance.GetText(42);
        gold5PriceText.text = DataService.Instance.GetText(43);
