...
public class TeeniepingCollectionPopup : BasePopup
{
    ...
    [SerializeField] private GameObject sideDescriptionEffectObj;
    ...
    public override void Init(int id = -1)
    {
        ...
        StartCoroutine(TeeniepingSideDescription_EffectOn());
    }
    ...
    IEnumerator TeeniepingSideDescription_EffectOn()
    {
        yield return YieldInstructionCache.WaitForSeconds(0.5f);
        sideDescriptionEffectObj.SetActive(true);
    }
