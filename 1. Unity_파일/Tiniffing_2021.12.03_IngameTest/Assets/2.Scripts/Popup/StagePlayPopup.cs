...
public class StagePlayPopup : BasePopup
{
    ...
    [SerializeField] private RectTransform teeniepingMindMissionTextImageRectTr;
    [SerializeField] private RectTransform teeniepingMindGroupTr;
    ...
    [SerializeField] private RectTransform startGroupRectTr;
    [SerializeField] private RectTransform startButtonTweenGroupRectTr;

    Sequence itemDoSacleUpSequence;
    Sequence itemDoSacleLoopSequence;
    Sequence startRotateSequence;
    Sequence missionTweenDisplaySequence;

    [SerializeField] AnimationCurve startButtonAnimationCurve;
    private void StagePlayPopupDisplay()
    {
        itemDoSacleLoopSequence = DOTween.Sequence()
        .InsertCallback(0.4f, () => TitleTweenDisplay())
        .InsertCallback(0.8f, () => MissionTweenDisplay())
        .InsertCallback(1.6f, () => ItemGroupTweenDisplay())
        .InsertCallback(1.7f, () => ItemIconUpDownLoopTween())
        .Insert(1.1f, startGroupRectTr.DOAnchorPosX(505, 0.7f)).SetEase(Ease.Linear)
        .InsertCallback(1.9f, () => StartButtonGroupRotateTween())
        .InsertCallback(2f, () => TweenEffect_CloseButton(closeButtonRect));
    }
    private void TitleTweenDisplay()
    {
        titleRectTr.DOScale(new Vector2(1.2f, 1.2f), 0.4f).OnComplete(() =>
        {
            titleRectTr.DOScale(new Vector2(1f, 1f), 0.4f);
        });
    }
    private void MissionTweenDisplay()
    {
        missionTweenDisplaySequence = DOTween.Sequence()
        .Prepend(teeniepingMindMissionTextImageRectTr.DOAnchorPosX(0, 0.3f).SetEase(Ease.Linear))
        .Insert(0.35f, teeniepingMindGroupTr.DOScale(new Vector2(1.2f, 1.2f), 0.2f))
        .Insert(0.55f, teeniepingMindGroupTr.DOScale(new Vector2(1f, 1f), 0.2f));
    }
    private void ItemGroupTweenDisplay()
    {
        itemDoSacleUpSequence = DOTween.Sequence()
        .Insert(0f, hintPoleGroupRectTr.DOScale(new Vector2(1.2f, 1.2f), 0.1f))
        .Insert(0f, timeStopGroupRectTr.DOScale(new Vector2(1.2f, 1.2f), 0.1f))
        .Insert(0f, protectionBraceletGroupRectTr.DOScale(new Vector2(1.2f, 1.2f), 0.1f))
        .Insert(0.1f, hintPoleGroupRectTr.DOScale(new Vector2(1f, 1f), 0.1f))
        .Insert(0.1f, timeStopGroupRectTr.DOScale(new Vector2(1f, 1f), 0.1f))
        .Insert(0.1f, protectionBraceletGroupRectTr.DOScale(new Vector2(1f, 1f), 0.1f));
    }
    private void ItemIconUpDownLoopTween()
    {

        itemDoSacleLoopSequence = DOTween.Sequence().SetDelay(5f)
        .Insert(0f, hintPoleRectTr.DOAnchorPosY(40f, 0.3f)).SetEase(Ease.Linear)//up
        .Insert(0f, timeStopRectTr.DOAnchorPosY(40f, 0.3f)).SetEase(Ease.Linear)//up
        .Insert(0f, protectionBraceletRectTr.DOAnchorPosY(40f, 0.3f)).SetEase(Ease.Linear)//up
        .Insert(0f, hintPoleRectTr.DOScaleY(1.1f, 0.3f)).SetEase(Ease.Linear)//scale up
        .Insert(0f, timeStopRectTr.DOScaleY(1.1f, 0.3f)).SetEase(Ease.Linear)//scale up
        .Insert(0f, protectionBraceletRectTr.DOScaleY(1.1f, 0.3f)).SetEase(Ease.Linear)//scale up

        .Insert(0.3f, hintPoleRectTr.DOAnchorPosY(28f, 0.1f)).SetEase(Ease.Linear)//down
        .Insert(0.3f, timeStopRectTr.DOAnchorPosY(28f, 0.1f)).SetEase(Ease.Linear)//down
        .Insert(0.3f, protectionBraceletRectTr.DOAnchorPosY(28f, 0.1f)).SetEase(Ease.Linear)//down
        .Insert(0.3f, hintPoleRectTr.DOScaleY(1f, 0.1f)).SetEase(Ease.Linear)//scale down
        .Insert(0.3f, timeStopRectTr.DOScaleY(1f, 0.1f)).SetEase(Ease.Linear)//scale down
        .Insert(0.3f, protectionBraceletRectTr.DOScaleY(1f, 0.1f)).SetEase(Ease.Linear)//scale down

        .Insert(0.4f, hintPoleRectTr.DOAnchorPosY(35f, 0.3f)).SetEase(Ease.Linear)//up
        .Insert(0.4f, timeStopRectTr.DOAnchorPosY(35f, 0.3f)).SetEase(Ease.Linear)//up
        .Insert(0.4f, protectionBraceletRectTr.DOAnchorPosY(35f, 0.3f)).SetEase(Ease.Linear)//up
        .Insert(0.4f, hintPoleRectTr.DOScaleY(1.05f, 0.3f)).SetEase(Ease.Linear)//scale up
        .Insert(0.4f, timeStopRectTr.DOScaleY(1.05f, 0.3f)).SetEase(Ease.Linear)//scale up
        .Insert(0.4f, protectionBraceletRectTr.DOScaleY(1.05f, 0.3f)).SetEase(Ease.Linear)//scale up

        .Insert(0.7f, hintPoleRectTr.DOAnchorPosY(28.5f, 0.1f)).SetEase(Ease.Linear)//down
        .Insert(0.7f, timeStopRectTr.DOAnchorPosY(28.5f, 0.1f)).SetEase(Ease.Linear)//down
        .Insert(0.7f, protectionBraceletRectTr.DOAnchorPosY(28.5f, 0.1f)).SetEase(Ease.Linear)//down
        .Insert(0.7f, hintPoleRectTr.DOScaleY(1f, 0.1f)).SetEase(Ease.Linear)//scale down
        .Insert(0.7f, timeStopRectTr.DOScaleY(1f, 0.1f)).SetEase(Ease.Linear)//scale down
        .Insert(0.7f, protectionBraceletRectTr.DOScaleY(1f, 0.1f)).SetEase(Ease.Linear)//scale down

        .Insert(0.8f, hintPoleRectTr.DOAnchorPosY(29, 0.1f)).SetEase(Ease.Linear)//end 29
        .Insert(0.8f, timeStopRectTr.DOAnchorPosY(29, 0.1f)).SetEase(Ease.Linear)//end 29
        .Insert(0.8f, protectionBraceletRectTr.DOAnchorPosY(29, 0.1f)).SetEase(Ease.Linear).OnComplete(() =>//end 29
        {
            itemDoSacleLoopSequence.Restart();
        });
    }
    private void StartButtonGroupRotateTween()
    {
        startRotateSequence = DOTween.Sequence().SetDelay(5f)
        .Insert(0f, startButtonTweenGroupRectTr.DOScale(new Vector2(-1f, 1f), 0.1f))
        .Insert(0.1f, startButtonTweenGroupRectTr.DOScale(new Vector2(0f, 1f), 0.1f))
        .Insert(0.2f, startButtonTweenGroupRectTr.DOScale(new Vector2(1f, 1f), 0.1f))
        .Insert(0.3f, startButtonTweenGroupRectTr.DOScale(new Vector2(-1f, 1f), 0.1f))
        .Insert(0.4f, startButtonTweenGroupRectTr.DOScale(new Vector2(0f, 1f), 0.3f))
        .Insert(0.5f, startButtonTweenGroupRectTr.DOScale(new Vector2(1f, 1f), 0.4f))
        .OnComplete(() => { startRotateSequence.Restart(); });
    }
    ...
    IEnumerator Tutorial()
    {
        ...
        if (!isReadFinished)
        {
            tutorialSpeechBubble0Text.text = DataService.Instance.GetText(962);
            tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(true);
            yield return new WaitUntil(() => isTouchScreenClick);
            isTouchScreenClick = false;
        }
        Tutorial_Step1();
        ...
        if (!isReadFinished)
        {
            ...
            tutorialSpeechBubble0Text.text = DataService.Instance.GetText(963);
            tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(true);
            yield return new WaitUntil(() => isTouchScreenClick);
            isTouchScreenClick = false;
        }
        ...
        if (!isReadFinished)
        {
            ...
            tutorialSpeechBubble0Text.text = DataService.Instance.GetText(964);
            tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(true);
            yield return new WaitUntil(() => isTouchScreenClick);
            isTouchScreenClick = false;
        }
        ...
        if (!isReadFinished)
        {
            ...
            tutorialSpeechBubble0Text.text = DataService.Instance.GetText(965);
            tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(true);
            yield return new WaitUntil(() => isTouchScreenClick);
            isTouchScreenClick = false;
        }
        ...
        if (!isReadFinished)
        {
            ...
            tutorialSpeechBubble0Text.text = DataService.Instance.GetText(966);
            tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(true);
            yield return new WaitUntil(() => isTouchScreenClick);
            isTouchScreenClick = false;
        }
        ...
        if (!isReadFinished)
        {
            ...
            tutorialSpeechBubble0Text.text = DataService.Instance.GetText(967);
            tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(true);
            yield return new WaitUntil(() => isTouchScreenClick);
            isTouchScreenClick = false;
        }
        ...
        if (!isReadFinished)
        {
            ...
            tutorialSpeechBubble0Text.text = DataService.Instance.GetText(968);
            tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(true);
            yield return new WaitUntil(() => isTouchScreenClick);
            isTouchScreenClick = false;
        }
        ...
        if (!isReadFinished)
        {
            ...
            tutorialSpeechBubble0Text.text = DataService.Instance.GetText(969);
            tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(true);
            yield return new WaitUntil(() => isTouchScreenClick);
            isTouchScreenClick = false;
        }
    ...
    private void Tutorial_Step0()
    {
        ...
        tutorialSpeechBubble0Text.DOText(DataService.Instance.GetText(962), 1.5f).SetEase(Ease.Linear).OnComplete(() => 
        { 
    ...
    private void Tutorial_Step1()
    {
        ...
        tutorialSpeechBubble0_NextTextObj.gameObject.SetActive(false);
