...
public class InGameClearPopup : BasePopup
{
    ...
    private void Perfect_Sequence_Display()
    {
        ...
        .Insert(3.5f, arrowSignGroupRectTr.DOAnchorPosX(505, 1.2f)).SetEase(Ease.Linear)
        .InsertCallback(3.5f, ()=>TweenEffect_CloseButton(closeButtonRectTr))
        .Insert(4.7f, nextStageButtonRectTr.DOAnchorPosX(8f, 0.3f).SetLoops(99999999, LoopType.Yoyo));
    }
    private void Fine_Sequence_Display()
    {
        ...
        .Insert(2.6f, arrowSignGroupRectTr.DOAnchorPosX(505, 1.2f)).SetEase(Ease.Linear)
        .InsertCallback(3.3f, () => TweenEffect_CloseButton(closeButtonRectTr))
    ...
    private void Bad_Sequence_Display()
    {
       // float defaultXpos = 
        ...
        .Insert(3.0f, arrowSignGroupRectTr.DOAnchorPosX(505, 1.2f)).SetEase(Ease.Linear)
        .InsertCallback(3.5f, () => TweenEffect_CloseButton(closeButtonRectTr))
        .Insert(4.2f, retryButtonRectTr.DOAnchorPosX(-22f, 0.3f).SetLoops(99999999, LoopType.Yoyo));
    }
