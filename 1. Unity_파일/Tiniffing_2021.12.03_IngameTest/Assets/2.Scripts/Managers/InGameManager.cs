...
public class InGameManager : MonoBehaviour
{
    ...
    InGameMissionPreview inGameMissionPreview;
    ...
    {
        InGameMissionPreviewOn();
        yield return new WaitUntil(() => inGameMissionPreview.isMissionPreviewFinished);
        ReadyEffectOn();
        yield return YieldInstructionCache.WaitForSeconds(1.801f);
        ReadyEffectOff();
        GoEffectOn();
        yield return YieldInstructionCache.WaitForSeconds(0.901f);
        GoEffectOff();
        OnCurtainUpEvent();
        // 커튼 올라가는 시간 0.8초
    ...
    private void InGameMissionPreviewOn()
    {
        GameObject inGameMissionPreviewObj = Instantiate(Resources.Load<GameObject>("Prefabs/InGameEffect/InGameMissionPreview"), canvasTr);
        inGameMissionPreview = inGameMissionPreviewObj.GetComponent<InGameMissionPreview>();
        inGameMissionPreview.Init();
    }
    ...
    public void OnCubeImageChange()
    {
        inGameUIInfo.CubeImageChange();
    }
