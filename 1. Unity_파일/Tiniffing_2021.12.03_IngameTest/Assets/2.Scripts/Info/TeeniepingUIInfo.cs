...
public class TeeniepingUIInfo : MonoBehaviour
{
    ...
    [SerializeField] private GameObject teeniepingNotOwnButtonObj;
    ...
    private void TeeniepingGetCheck(Table.TiniffingCollectionTable teeniepingCollectionData)
    {
        ...
        if (teeniepingCollectionData.get_check == 0)
        {
            ...
            teeniepingNotOwnButtonObj.SetActive(true);
    ...
    public void NotOwnTeeniepingButtonClick()
    {
        var teeniepingCollectionData = DataService.Instance.GetData<Table.TiniffingCollectionTable>(id);
        PopupContainer.SetIndexData(teeniepingCollectionData.get_chapter);
        PopupContainer.CreatePopup(PopupType.TeeniepingCollectionHowToGetNoticePopup).Init();
    }
