...
Shader "OTH/Alphablend_Trail"
{
	Properties
	{
		...
		_Mask_Pow("Mask_Pow", Range( 1 , 10)) = 1.863975
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 temp_output_10_0 = ( tex2DNode2.r * pow( tex2D( _Mask_Texture, uv_Mask_Texture ) , temp_cast_2 ) );
			...
			float2 rotator55 = mul( uv_Dissolve_Texture - temp_cast_3 , float2x2( cos55 , -sin55 , sin55 , cos55 )) + temp_cast_3;
			float2 panner44 = ( 1.0 * _Time.y * appendResult45 + rotator55);
				...
				float4 staticSwitch53 = floor( ( ( temp_output_10_0 * saturate( ( tex2D( _Dissolve_Texture, panner44 ).r + staticSwitch54 ) ) ) * 4.0 ) );
			#else
				float4 staticSwitch53 = temp_output_10_0;
			#endif
			o.Alpha = ( i.vertexColor.a * saturate( ( _Opacity * staticSwitch53 ) ) ).r;
		}
...
/*ASEBEGIN
Version=18935
0;73;1448;633;2873.07;78.62727;1.704262;True;False
...
Node;AmplifyShaderEditor.SamplerNode;22;-2135.122,-456.8442;Inherit;True;Property;_Noise_Texure;Noise_Texure;13;0;Create;True;0;0;0;False;0;False;-1;None;f99cd2cad01a9ec4c9f1d25eebf10402;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-1809.121,-253.8442;Float;False;Property;_Noise_Str;Noise_Str;15;0;Create;True;0;0;0;False;0;False;0.58;0.16;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-1480.649,1239.113;Float;False;Property;_Diss_Tex_VPanner;Diss_Tex_VPanner;21;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-1442.496,1164.987;Float;False;Property;_Diss_Tex_UPanner;Diss_Tex_UPanner;20;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-1552.752,424.7238;Inherit;True;0;68;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-954.1753,1206.092;Float;False;Property;_Dissolve;Dissolve;19;0;Create;True;0;0;0;False;0;False;1;1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;68;-1305.245,497.0136;Inherit;True;Property;_Mask_Texture;Mask_Texture;11;0;Create;True;0;0;0;False;0;False;-1;None;b350efef325656e479cbb209273c6cf7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;40;-773.2475,996.0739;Inherit;True;Property;_Dissolve_Texture;Dissolve_Texture;17;0;Create;True;0;0;0;False;0;False;-1;8d21b35fab1359d4aa689ddf302e1b01;8d21b35fab1359d4aa689ddf302e1b01;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1284.815,717.8552;Float;False;Property;_Mask_Pow;Mask_Pow;12;0;Create;True;0;0;0;False;0;False;1.863975;1;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;11;-929.8149,547.8552;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-553.2601,343.6404;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;48;-281.7242,1022.103;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;-96.52312,858.0287;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;65;-571.1034,-296.3624;Inherit;False;Property;_Lerp_Val;Lerp_Val;23;0;Create;True;0;0;0;False;0;False;0;-0.87;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;201.64,1019.676;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;67;-284.3492,-264.4207;Float;False;Property;_Use_Custom_Lerp;Use_Custom_Lerp;14;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FloorOpNode;50;397.64,858.6756;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;53;395.3744,355.5274;Float;True;Property;_Use_Toon_Disoove;Use_Toon_Disoove;22;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;8;-305.2404,-643.7484;Float;False;Property;_Lerp_Tint_Color_A;Lerp_Tint_Color_A;3;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;2.947605,3.374169,5.080425,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;62;-299.4601,-454.029;Float;False;Property;_Lerp_Tint_Color_B;Lerp_Tint_Color_B;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;2.819895,0.8379877,2.665059,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;643.8601,190.8269;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;15;798.3122,188.0154;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=62E54EAED907D2D073155B4F0CCCAE724160B715