...
Shader "ToonShader/CelShader_limtex"
{
	Properties
	{
		...
		_Tex_Line("Tex_Line", 2D) = "white" {}
		_Tex_Upanner("Tex_Upanner", Float) = 1
		_Tex_Vpanner("Tex_Vpanner", Float) = 0
		[Toggle(_TEXTURE_LINE_ONOFF_ON)] _Texture_Line_OnOff("Texture_Line_On/Off", Float) = 0
		[HDR]_Tex_Line_Color("Tex_Line_Color", Color) = (0,0,0,0)
		_Tex_Uoffset("Tex_Uoffset", Float) = 0
		_Tex_Voffset("Tex_Voffset", Float) = 0
		_Tex_Pow("Tex_Pow", Float) = 1
		_Tex_Ins("Tex_Ins", Float) = 1
	...
	SubShader
	{
		...
		#pragma target 4.6
		#pragma shader_feature _TEXTURE_LINE_ONOFF_ON
		...
		uniform float4 _Tex_Line_Color;
		uniform sampler2D _Tex_Line;
		uniform float _Tex_Upanner;
		uniform float _Tex_Vpanner;
		uniform float4 _Tex_Line_ST;
		uniform float _Tex_Uoffset;
		uniform float _Tex_Voffset;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float dotResult123 = dot( i.viewDir , ase_worldNormal );
				...
				float staticSwitch150 = 1.0;
			#endif
			float2 appendResult189 = (float2(_Tex_Upanner , _Tex_Vpanner));
			float2 uv0_Tex_Line = i.uv_texcoord * _Tex_Line_ST.xy + _Tex_Line_ST.zw;
			float2 appendResult193 = (float2(_Tex_Uoffset , _Tex_Voffset));
			float2 panner182 = ( 1.0 * _Time.y * appendResult189 + (uv0_Tex_Line*1.0 + appendResult193));
			float4 temp_cast_0 = (_Tex_Pow).xxxx;
			#ifdef _TEXTURE_LINE_ONOFF_ON
				float4 staticSwitch185 = ( ( pow( ( _Tex_Line_Color * tex2D( _Tex_Line, panner182 ) ) , temp_cast_0 ) * _Tex_Ins ) + lerp(temp_output_171_0,( temp_output_171_0 + ( pow( ( 1.0 - saturate( ( dotResult123 + _Rimoffset ) ) ) , _RimScale ) * _RimColor * staticSwitch150 ) ),_RimToggle) );
			#else
				float4 staticSwitch185 = lerp(temp_output_171_0,( temp_output_171_0 + ( pow( ( 1.0 - saturate( ( dotResult123 + _Rimoffset ) ) ) , _RimScale ) * _RimColor * staticSwitch150 ) ),_RimToggle);
			#endif
			c.rgb = staticSwitch185.rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=16700
0;73;1619;622;-576.8804;843.6161;3.903843;True;False
...
Node;AmplifyShaderEditor.SamplerNode;50;-155.0696,1190.828;Float;True;Property;_LimTex;LimTex;3;0;Create;True;0;0;False;0;None;3756157c64cf9c143bb69a7cae736634;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;69;-1580.876,-384.8831;Float;False;1293.428;662.0965;RemapMask/对limTex.g x vertex.r값을 다시 매핑하려면;16;85;71;84;72;70;81;80;82;78;83;79;74;76;75;77;73;remap 다시 맵핑;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;19;-1509.903,317.602;Float;False;1217.422;611.6746;半兰伯特漫反射;10;7;5;6;4;3;1;2;20;18;17;半兰伯特漫反射;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;54;375.0551,1319.828;Float;False;ShadowMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;2;-1426.649,730.6772;Float;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.WorldNormalVector;1;-1413.117,420.7948;Float;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-1132.73,711.0491;Float;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DotProductOpNode;3;-1135.776,529.381;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4;-972.1987,479.7844;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;76;-1174.14,21.6684;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-944.7689,677.7853;Float;False;Constant;_Float1;Float 1;0;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;6;-810.2948,530.6732;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightAttenuation;17;-787.05,744.0679;Float;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-644.6388,596.1372;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;20;-514.8995,509.2357;Float;False;halflambert;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;155;1304.874,537.1782;Float;False;Property;_FirstShadowSmoothoffset;FirstShadowSmoothoffset;5;0;Create;True;0;0;False;0;0;0.351;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;1201.349,283.6027;Float;False;Property;_FirstShadowThre;FirstShadowThre;4;0;Create;True;0;0;False;0;0.5;0.462;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;23;-78.97056,150.12;Float;False;819.9445;439.2;첫 번째 그림자;4;25;15;13;11;FirstShadowColor;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;39;-277.7409,-15.2621;Float;True;Property;_Maintex;Maintex;0;0;Create;True;0;0;False;0;None;3756157c64cf9c143bb69a7cae736634;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;11;289.6835,423.7145;Float;False;Property;_FirstShadowColor;FirstShadowColor;6;0;Create;True;0;0;False;0;0.1509434,0.1509434,0.1509434,0;0.1509434,0.1509434,0.1509434,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;22;-26.35712,-421.1687;Float;False;517;491;색상;3;16;12;14;Main_Color;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;41;-80.57648,668.5309;Float;False;617;361;두 번째 그림자;2;42;43;SecondShadowColor;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;13;277.067,197.2424;Float;True;Property;_SSSTex;SSSTex;2;0;Create;True;0;0;False;0;None;3756157c64cf9c143bb69a7cae736634;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;110;357.8255,2107.825;Float;False;Property;_Specgloss;Specgloss;9;0;Create;True;0;0;False;0;5.647059;1;1;30;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;191;2597.362,498.2367;Float;False;Property;_Tex_Uoffset;Tex_Uoffset;28;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;192;2598.773,639.5344;Float;False;Property;_Tex_Voffset;Tex_Voffset;29;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;133;2145.358,2192.074;Float;False;Property;_Rimoffset;Rimoffset;16;0;Create;True;0;0;False;0;0.482353;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;12;41.5922,-100.1977;Float;False;Property;_MainColor;MainColor;1;0;Create;True;0;0;False;0;1,0.9103774,0.9103774,0;1,0.9103774,0.9103774,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;47;882.5093,834.5455;Float;False;Property;_SceondShadowThre;SceondShadowThre;7;0;Create;True;0;0;False;0;0.5;0.132;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;42;21.42352,773.5309;Float;False;Property;_SecondShadowColor;SecondShadowColor;8;0;Create;True;0;0;False;0;0,0,0,0;0.3962264,0.3962264,0.3962264,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DynamicAppendNode;193;2793.115,522.9374;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;183;2585.482,311.1999;Float;False;0;179;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;184;2935.666,554.2893;Float;False;Property;_Tex_Upanner;Tex_Upanner;24;0;Create;True;0;0;False;0;1;-0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;188;2946.193,679.9767;Float;False;Property;_Tex_Vpanner;Tex_Vpanner;25;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;190;2871.812,320.7366;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;189;3171.322,555.0932;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;112;661.8251,2139.825;Float;False;Property;_Specolor;Specolor;10;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;161;2330.799,151.5811;Float;False;Property;_EmissionMult;EmissionMult;21;0;Create;True;0;0;False;0;0;0.32;0;11;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;162;2102.798,79.58109;Float;False;Property;_EmissionColor;EmissionColor ;20;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;169;836.9086,1516.686;Float;False;Property;_Inline;Inline;22;0;Create;True;0;0;False;0;0;0.038;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;182;3109.47,320.3298;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;128;2584.891,2204.779;Float;False;Property;_RimScale;RimScale;14;0;Create;True;0;0;False;0;0;0.01;0.01;11;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;150;3373.944,2352.911;Float;False;Property;_Rimtype;Rimtype;13;0;Create;True;0;0;False;0;0;0;0;True;;KeywordEnum;3;normal;halflambert;backlight;Create;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;186;3418.281,47.84591;Float;False;Property;_Tex_Line_Color;Tex_Line_Color;27;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.2245906,0.4622642,0.2763301,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;132;3018.498,2192.824;Float;False;Property;_RimColor;RimColor;15;0;Create;True;0;0;False;0;0.6415094,0.6415094,0.6415094,0;0.6415094,0.6415094,0.6415094,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;179;3327.28,287.6585;Float;True;Property;_Tex_Line;Tex_Line;23;0;Create;True;0;0;False;0;None;bbd5f397c453a4644b0d07074a3b3e8c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;187;3628.875,287.3182;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;198;3696.592,526.6602;Float;False;Property;_Tex_Pow;Tex_Pow;30;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;197;3834.57,286.3091;Float;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;136;2625.857,1293.456;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;200;3886.727,529.8461;Float;False;Property;_Tex_Ins;Tex_Ins;31;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;135;2679.736,1001.444;Float;True;Property;_RimToggle;RimToggle;12;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;199;4079.371,290.7602;Float;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;144;4131.075,1110.717;Float;False;Property;_OutlineColor;OutlineColor;17;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;145;4159.575,1290.417;Float;False;Property;_OutlineWidth;OutlineWidth;18;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;181;4310.301,298.2116;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;168;996.057,1384.397;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OutlineNode;143;4350.823,1094.235;Float;False;0;True;None;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;185;4491.631,538.5571;Float;False;Property;_Texture_Line_OnOff;Texture_Line_On/Off;26;0;Create;True;0;0;False;0;0;0;1;True;;Toggle;2;Key0;Key1;Create;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;4865.854,432.2562;Float;False;True;6;Float;ASEMaterialInspector;0;0;CustomLighting;ToonShader/CelShader_limtex;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0.05;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;13;185;0
WireConnection;0;11;143;0
ASEEND*/
//CHKSM=2E4041CDD583F04ABD42C38C441D0998BE907B13