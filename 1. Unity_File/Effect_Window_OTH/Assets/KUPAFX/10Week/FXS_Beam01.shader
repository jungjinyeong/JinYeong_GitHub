...
Shader "KUPAFX/Beam01"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult19 = (float2(( ( _Dissolve_U_Rotate * uv_Dissove_Texture.x ) + uv_Dissove_Texture.x ) , uv_Dissove_Texture.y));
...
/*ASEBEGIN
Version=18935
0;73;1085;711;2010.224;452.3138;1.3;True;False
Node;AmplifyShaderEditor.RangedFloatNode;22;-1543.353,-242.5802;Inherit;False;Property;_Dissolve_U_Rotate;Dissolve_U_Rotate;8;0;Create;True;0;0;0;False;0;False;0.98;1.12;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-1652.088,1.146374;Inherit;False;0;6;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-1304.327,-222.2136;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-1041.278,-0.01330185;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=8911C0770991E1B148E86A3D708A3FA96A027DC8