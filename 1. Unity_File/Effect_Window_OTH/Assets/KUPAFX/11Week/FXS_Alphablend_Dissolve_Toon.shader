...
Shader "KUPAFX/Alphablend_Dissolve_Toon"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			o.Alpha = ( i.vertexColor.a * saturate( floor( ( ( tex2D( _Main_Texature, (uv0_Main_Texature*1.0 + appendResult28) ).r * ( tex2D( _Dissolve_Texture, rotator18 ).r + staticSwitch13 ) ) * 2.0 ) ) ) );
		}
...
/*ASEBEGIN
Version=16700
216;212;1920;750;-118.3147;381.1115;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-1801,336.5;Float;False;Property;_Dissolve;Dissolve;6;0;Create;True;0;0;False;0;1;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-1079,117.5;Float;True;Property;_Dissolve_Texture;Dissolve_Texture;5;0;Create;True;0;0;False;0;8d21b35fab1359d4aa689ddf302e1b01;8d21b35fab1359d4aa689ddf302e1b01;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-867,-189.5;Float;True;Property;_Main_Texature;Main_Texature;0;0;Create;True;0;0;False;0;e2edd7b4dad5d0b449ceac40e4a0bb87;0d2fc2a364f1f7847b6c51384a5f1109;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;9;-227,-402.5;Float;False;Property;_TintColor;Tint Color;1;1;[HDR];Create;True;0;0;False;0;1,0.6931067,0,0;0.6886792,0.6886792,0.6886792,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=AA149F1EBA4DBBCCC597CAAD26A77661C9D83021