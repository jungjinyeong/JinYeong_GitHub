...
Shader "KUPAFX/Additve_Dissolve"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			o.Emission = ( ( ( _Tint_Color * ( pow( tex2D( _Main_Texture, i.uv_texcoord ).r , _Main_Pow ) * staticSwitch7 ) ) * saturate( ( tex2D( _Dissove_Texture, uv0_Dissove_Texture ).r + staticSwitch19 ) ) ) * i.vertexColor ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16700
0;0;1920;1019;1212.129;76.49338;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;1;-933.1031,-155.962;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;3;-708.968,65.86609;Float;False;Property;_Main_Pow;Main_Pow;3;0;Create;True;0;0;False;0;4;1;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-714.9119,-160.1665;Float;True;Property;_Main_Texture;Main_Texture;0;0;Create;True;0;0;False;0;d4003115653d0f549a9ad4aa3dae1c47;b32ac9c7987c0714b9a0509bf57063c1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-869.7416,473.5154;Float;False;0;13;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-633.0415,689.8154;Float;False;Property;_Dissolve;Dissolve;5;0;Create;True;0;0;False;0;1;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;8;-128.6649,-280.4263;Float;False;Property;_Tint_Color;Tint_Color;1;1;[HDR];Create;True;0;0;False;0;1,1,1,1;1.452128,0.7092033,0.486326,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;601.3351,-110.4263;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=FB1CB6B0E4D84F811C0CFF4754C1866B44144BD4