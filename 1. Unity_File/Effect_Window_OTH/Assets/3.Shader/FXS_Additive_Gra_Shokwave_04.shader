...
Shader "OTH/Additive_Gra_Shokwave_04"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Alpha = ( i.vertexColor.a * ( tex2D( _Mask_Texture, panner66 ) * saturate( pow( saturate( ( ( ( uv0_Mask_Texture.y * 1.0 ) * ( 1.0 - uv0_Mask_Texture.y ) * _Mask_Ins ) * 4.0 ) ) , _Mask_Pow ) ) ) ).r;
		}
...
/*ASEBEGIN
Version=16700
-1920;224;1920;1011;1361.177;-1022.505;1.423182;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;-579.9388,2094.17;Float;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;83;-312.689,2091.94;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;4;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;80;-37.8608,2095.012;Float;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;75;177.6033,2094.319;Float;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;84;464.7657,1937.612;Float;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;73;585.8132,1606.204;Float;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D4525ECAFC5E7DE78CF348077DF2B56CA5077B0B