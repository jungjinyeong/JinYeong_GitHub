...
Shader "OTH/Additive_Gra_Shokwave_05_Depth_Fade"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float screenDepth64 = LinearEyeDepth(UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture,UNITY_PROJ_COORD( ase_screenPos ))));
			float distanceDepth64 = abs( ( screenDepth64 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( _Depth_Fade ) );
			o.Alpha = ( ( i.vertexColor.a * saturate( pow( ( saturate( ( i.uv_texcoord.y * ( 1.0 - i.uv_texcoord.y ) ) ) * 4.0 ) , _Mask_Pow ) ) ) * saturate( distanceDepth64 ) );
		}
...
/*ASEBEGIN
Version=16700
-1920;224;1920;1011;973.0474;203.0012;1.315369;True;False
Node;AmplifyShaderEditor.RangedFloatNode;25;-3348.148,-141.8199;Float;False;Property;_Noise_VPanner;Noise_VPanner;8;0;Create;True;0;0;False;0;0;-0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-2533.164,-224.0765;Float;False;Property;_Noise_Val;Noise_Val;7;0;Create;True;0;0;False;0;0;0.907;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-2273.461,172.0562;Float;False;Property;_Gra_Offset;Gra_Offset;2;0;Create;True;0;0;False;0;0;0.14;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-1968.423,-667.3661;Float;False;Property;_Sub_Ins;Sub_Ins;13;0;Create;True;0;0;False;0;0;2.1;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-723.0547,219.9654;Float;False;Property;_Gra_Pow;Gra_Pow;4;0;Create;True;0;0;False;0;1;1.8;1;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-645.5518,855.7322;Float;False;Property;_Mask_Pow;Mask_Pow;10;0;Create;True;0;0;False;0;8;1;1;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;65;230.5153,797.9947;Float;False;Property;_Depth_Fade;Depth_Fade;19;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;40;-39.32531,1003.702;Float;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;64;534.3656,715.1264;Float;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;14;-100.7945,268.3624;Float;False;Property;_Gra_Color;Gra_Color;5;1;[HDR];Create;True;0;0;False;0;1,1,1,0;1.418075,0.4991342,2.118547,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;66;819.8003,663.827;Float;True;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=5F0189EB385FB79DDF7D00088300F75123FF1DE0