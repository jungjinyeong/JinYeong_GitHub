...
Shader "OTH/Alphablen_Sword_Toon_Lerp"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( ( ( pow( ( saturate( ( ( 1.0 - i.uv_texcoord.x ) + staticSwitch91 ) ) * temp_output_108_0 ) , 3.0 ) * staticSwitch98 ) * _Color0 ) + ( lerpResult113 * ( pow( temp_output_108_0 , _Main_Pow ) * _Main_Ins ) ) ) * i.vertexColor ).rgb;
			o.Alpha = ( i.vertexColor.a * temp_output_71_0 );
		}
...
/*ASEBEGIN
Version=18935
0;73;1209;711;844.876;941.561;2.159726;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;68;19.78792,-297.978;Float;False;Property;_Main_Pow;Main_Pow;3;0;Create;True;0;0;0;False;0;False;0;1.91;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;84;562.1282,563.5415;Float;False;Property;_Emi_Lerp_Color_B;Emi_Lerp_Color_B;9;1;[HDR];Create;True;0;0;0;False;0;False;0.1623798,0.7381574,0.8396226,0;0.6018524,0.1321645,0.8490566,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;112;563.3982,369.76;Float;False;Property;_Emi_Lerp_Color_A;Emi_Lerp_Color_A;8;1;[HDR];Create;True;0;0;0;False;0;False;0.2450042,0.9058824,0.2196078,0;0.1861297,0.01601993,0.3773585,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;113;768.7236,-358.4221;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;115;353.3177,-1119.789;Float;False;Property;_Color0;Color 0;7;1;[HDR];Create;True;0;0;0;False;0;False;0.2450042,0.9058824,0.2196078,0;0.2450042,0.9058824,0.2196078,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VertexColorNode;95;1198.163,-616.227;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;23;334.2344,-691.2458;Float;False;Property;_Tint_Color;Tint_Color;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;3.063796,3.063796,3.063796,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;97;1414.164,-385.227;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;96;1387.164,-797.227;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=21F7964474E7F7BF6DF3A9BF0C1CE16F816432CA