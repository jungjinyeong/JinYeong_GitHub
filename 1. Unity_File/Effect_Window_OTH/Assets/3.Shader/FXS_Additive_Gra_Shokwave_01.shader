...
Shader "OTH/Additive_Gra_Shokwave_01"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode1 = tex2D( _Gra_Texture, (( ( (UnpackNormal( tex2D( _Noise_Texture, panner23 ) )).xy * _Noise_Val ) + uv0_Gra_Texture )*1.0 + appendResult7) );
			...
			o.Alpha = ( i.vertexColor.a * saturate( pow( ( 1.0 - abs( ( i.uv_texcoord.y - 0.5 ) ) ) , _Mask_Pow ) ) );
		}
...
/*ASEBEGIN
Version=16700
0;13;2560;993;2867.583;551.1603;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-2182.048,-253.62;Float;False;Property;_Noise_Val;Noise_Val;7;0;Create;True;0;0;False;0;0;0.907;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-2264.229,172.0562;Float;False;Property;_Gra_Offset;Gra_Offset;2;0;Create;True;0;0;False;0;0;-0.33;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;59;-2264.382,315.9394;Float;True;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-1968.423,-667.3661;Float;False;Property;_Sub_Ins;Sub_Ins;13;0;Create;True;0;0;False;0;0;3.3;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;42;-1634.526,562.3415;Float;False;1793.199;875.8582;Mask;13;30;27;29;31;33;28;32;34;36;37;40;38;35;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-723.0547,219.9654;Float;False;Property;_Gra_Pow;Gra_Pow;4;0;Create;True;0;0;False;0;1;3.8;1;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-645.5518,855.7322;Float;False;Property;_Mask_Pow;Mask_Pow;10;0;Create;True;0;0;False;0;8;6.3;1;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;14;-100.7945,268.3624;Float;False;Property;_Gra_Color;Gra_Color;5;1;[HDR];Create;True;0;0;False;0;1,1,1,0;1.811765,0.9726142,0.2561133,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;35;-1189.792,1184.201;Float;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-897.9571,1022.258;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=BDCDDE415632D68BC36B841998A7212B48F050F8