...
Shader "OTH/Alphablend_Dissolve_Toon_Twoside"
{
	Properties
	{
		...
		[HDR]_Tint_Color_A("Tint_Color_A", Color) = (1,1,1,0)
		[Toggle(_USE_CUSTOM_ON)] _Use_Custom("Use_Custom", Float) = 0
		[HDR]_Tint_Color_B("Tint_Color_B", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		uniform float4 _Tint_Color_A;
		uniform float4 _Tint_Color_B;
		...
		{
			float4 switchResult36 = (((i.ASEVFace>0)?(_Tint_Color_A):(_Tint_Color_B)));
			#ifdef _USE_CUSTOM_ON
				float staticSwitch25 = i.uv2_texcoord2.y;
			#else
				float staticSwitch25 = _Main_Ins;
			#endif
			o.Emission = ( i.vertexColor * ( switchResult36 * staticSwitch25 ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;73;982;696;1589.4;975.1177;2.164448;True;False
Node;AmplifyShaderEditor.RangedFloatNode;16;-1706.862,742.4692;Float;False;Property;_Dissolve_Rotator1;Dissolve_Rotator1;8;0;Create;True;0;0;0;False;0;False;0;3.86;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-1228.32,767.1997;Float;False;Property;_Dissolve;Dissolve;7;0;Create;True;0;0;0;False;0;False;1;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;11;-931.183,761.2794;Float;False;Property;_Use_Custom;Use_Custom;2;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2;-1010.928,527.8905;Inherit;True;Property;_Dissolve_Texture;Dissolve_Texture;6;0;Create;True;0;0;0;False;0;False;-1;8d21b35fab1359d4aa689ddf302e1b01;8d21b35fab1359d4aa689ddf302e1b01;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;18;-757.4622,-570.178;Float;False;Property;_Tint_Color_A;Tint_Color_A;4;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1.667673,1.061609,1.89127,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;33;-81.96363,931.7836;Float;False;Property;_Depth_Fade;Depth_Fade;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;37;-758.2515,-364.7428;Float;False;Property;_Tint_Color_B;Tint_Color_B;5;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1.667673,1.061609,1.89127,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SwitchByFaceNode;36;-295.3739,-253.9382;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;1427.853,187.4798;Float;False;Property;_Cull_Mode;Cull_Mode;10;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=5C1B82365EC332B25812D5545B3F2FBE8167CC03