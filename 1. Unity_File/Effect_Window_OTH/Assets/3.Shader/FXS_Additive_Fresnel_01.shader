...
Shader "OTH/Additive_Fresnel_01"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_3_0_g3 = ( staticSwitch20 - tex2DNode14.r );
			...
			float temp_output_3_0_g4 = ( ( staticSwitch20 + _Step_Size_Int ) - tex2DNode14.r );
			float temp_output_43_0 = saturate( ( temp_output_3_0_g4 / fwidth( temp_output_3_0_g4 ) ) );
			o.Emission = ( ( ( tex2D( _Main_Texture, uv_Main_Texture ) * temp_output_42_0 * i.vertexColor ) + saturate( ( fresnelNode3 * _Color0 ) ) ) + ( i.vertexColor.a * ( temp_output_43_0 - temp_output_42_0 ) * _Dissolve_Color * saturate( _Dissolve_Int ) ) ).rgb;
...
/*ASEBEGIN
Version=16700
1812;39;1920;1019;3744.435;553.7277;2.12036;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-3221.774,738.9929;Float;False;Property;_Dissolve_Val;Dissolve_Val;7;0;Create;True;0;0;False;0;0;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-2238.364,-242.7257;Float;False;Property;_F_Pow;F_Pow;3;0;Create;True;0;0;False;0;5;7.64;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-2239.826,-349.4484;Float;False;Property;_F_Scale;F_Scale;4;0;Create;True;0;0;False;0;5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-3073.506,1140.425;Float;False;Property;_Step_Size_Int;Step_Size_Int;8;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;5;-2002.882,-226.1611;Float;False;Property;_Color0;Color 0;2;1;[HDR];Create;True;0;0;False;0;1,1,1,0;2.317495,0.6992495,0.4263316,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;41;-2619.022,911.1901;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;14;-2932.033,476.1649;Float;True;Property;_Noise_Texture;Noise_Texture;6;0;Create;True;0;0;False;0;03344d3d32e85af4faf109e635145a9b;41a89d3615ad8f34e9bd4fd043a70610;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;43;-2318.028,885.2769;Float;True;Step Antialiasing;-1;;4;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;2;-1739.175,259.9499;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;42;-2310.054,498.569;Float;True;Step Antialiasing;-1;;3;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;-2345.292,-13.77772;Float;True;Property;_Main_Texture;Main_Texture;1;0;Create;True;0;0;False;0;40526e53665b54f4ab08530fa57888a3;40526e53665b54f4ab08530fa57888a3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;49;-1481.886,1011.892;Float;False;Property;_Dissolve_Int;Dissolve_Int;5;0;Create;True;0;0;False;0;0;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;48;-1577.884,771.1917;Float;False;Property;_Dissolve_Color;Dissolve_Color;10;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6B8A7AC897B57E4A4C515C71A6242E6D7EFA0B82