...
Shader "OTH/Additve_Sword_Edge_2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			o.Emission = ( i.vertexColor * ( ( ( ( ( saturate( temp_output_4_0 ) * tex2D( _Sword_Texture, (uv_Sword_Texture*1.0 + appendResult43) ) ) * staticSwitch27 ) * _Edge_Color ) * saturate( ( tex2D( _Dissolve_Texture, panner18 ) + staticSwitch28 ) ) ) * ( pow( ( ( ( i.uv_texcoord.x * 1.0 ) * ( 1.0 - i.uv_texcoord.x ) ) * 4.0 ) , _Mask_Pow ) * _Mask_Ins ) ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;73;1573;588;3297.682;1247.78;1.375079;True;False
...
Node;AmplifyShaderEditor.SamplerNode;48;-1835.522,-984.9187;Inherit;True;Property;_Noise_Texture;Noise_Texture;10;0;Create;True;0;0;0;False;0;False;-1;None;f7cf4535dc45d15458b45e26a23587f2;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-1414.414,-726.3106;Inherit;False;Property;_Noise_Val;Noise_Val;13;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;44;-1517.372,199.871;Float;False;Property;_Use_Custom;Use_Custom;14;0;Create;False;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-843.7255,-209.0397;Float;False;Property;_Edge_Range;Edge_Range;3;0;Create;True;0;0;0;False;0;False;-0.9176471;-0.69;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;11;471,121.5;Float;False;Property;_Edge_Color;Edge_Color;4;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;13.76636,1.80188,2.594707,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0D07C5DE24017B619A285A95A258B70D4F1A0E3D