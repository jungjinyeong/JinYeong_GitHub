...
Shader "OTH/Alphablend_Spear_01"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_3_0_g16 = ( ( staticSwitch20 + _Step_Size_Int ) - tex2DNode14.r );
			float temp_output_43_0 = saturate( ( temp_output_3_0_g16 / fwidth( temp_output_3_0_g16 ) ) );
...
/*ASEBEGIN
Version=16700
-1920;224;1920;1011;4587.927;612.1071;1.3;True;False
...
Node;AmplifyShaderEditor.FunctionNode;43;-2318.028,885.2769;Float;True;Step Antialiasing;-1;;16;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=E248A6C6DAA8C27D28EA109C9FCE6C277F839B6A