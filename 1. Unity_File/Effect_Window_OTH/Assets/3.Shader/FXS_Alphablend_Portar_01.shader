...
Shader "OTH/Alphablend_SubWave"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float screenDepth98 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy ));
			float distanceDepth98 = abs( ( screenDepth98 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( _Depth_Fade ) );
			o.Alpha = ( ( i.vertexColor.a * saturate( ( pow( tex2D( _TextureSample0, uv_TextureSample0 ) , temp_cast_8 ) * _Mask_Out_Ins ) ) ) * saturate( distanceDepth98 ) ).r;
		}
...
/*ASEBEGIN
Version=18935
0;73;1022;726;-1174.025;512.3798;1.390314;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-1567.098,-606.7047;Float;False;Property;_Desaturate_Val;Desaturate_Val;18;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;78;245.9859,426.9381;Inherit;True;Property;_TextureSample0;Texture Sample 0;21;0;Create;True;0;0;0;False;0;False;-1;None;fd3d49fb3a392684d93e1fb3a9c6ad4e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;100;1782.152,267.6954;Inherit;False;Property;_Depth_Fade;Depth_Fade;24;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;56;-503.596,-1144.921;Float;False;Property;_Sub_Color;Sub_Color;14;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1.507412,1.785992,1.449365,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;41;178.0635,-370.3665;Float;False;Property;_Main_Color;Main_Color;8;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1.040586,0.779313,1.049595,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DepthFade;98;2014.975,94.95587;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;101;2340.427,104.9697;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;102;1841.375,-74.43094;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
WireConnection;102;0;70;0
WireConnection;102;1;101;0
WireConnection;0;2;58;0
WireConnection;0;9;102;0
ASEEND*/
//CHKSM=425A4325E9F1471B0AD3CC331090A87E41BAC0B4