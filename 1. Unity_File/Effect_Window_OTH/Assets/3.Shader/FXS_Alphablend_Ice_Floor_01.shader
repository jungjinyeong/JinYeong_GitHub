...
Shader "OTH/Alphablend_Ice_Floor_01"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			o.Alpha = ( i.vertexColor.a * step( temp_cast_1 , ( saturate( ( tex2D( _Ice_Tex_Smoke, ( float3( i.uv_texcoord.xy ,  0.0 ) + ( (UnpackNormal( tex2D( _Ice_Tex_Normal, uv_Ice_Tex_Normal ) )).xyz * 0.1 ) ).xy ) * staticSwitch82 ) ) * saturate( ( tex2D( _Dissolve_Texture, i.uv_texcoord.xy ) + staticSwitch71 ) ) ) ) ).r;
		}
...
/*ASEBEGIN
Version=18935
0;73;1007;605;525.4575;-42.03821;1.625608;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;66;480.0947,803.147;Float;False;Property;_Dissolve_Val;Dissolve_Val;6;0;Create;True;0;0;0;False;0;False;1;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;53;654.5428,-3.047759;Inherit;True;Property;_Ice_Tex_Smoke;Ice_Tex_Smoke;3;0;Create;True;0;0;0;False;0;False;-1;a466d9e2abfe11c439ffdeb4cdcb4573;a466d9e2abfe11c439ffdeb4cdcb4573;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;67;1242.665,578.1137;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;80;881.5948,-672.8555;Float;False;Property;_Tint_Color;Tint_Color;8;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1.498039,1.498039,1.498039,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StepOpNode;57;1695.157,113.4191;Inherit;True;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;77;1469.83,-418.7112;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;1716.33,-411.3452;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;79;1911.372,99.08614;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=AFA470FC3E433A47D287D51F68E4814DC6E776E3