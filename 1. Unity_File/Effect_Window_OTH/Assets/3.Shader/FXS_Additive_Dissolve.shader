...
Shader "OTH/Additive_Dissolve"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			o.Emission = ( ( ( _Tint_Color * ( pow( tex2D( _Main_Texture, i.uv_texcoord ).r , _Main_Power ) * staticSwitch20 ) ) * saturate( ( tex2D( _Dissove_Texture, uv0_Dissove_Texture ).r + staticSwitch21 ) ) ) * i.vertexColor ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16700
0;11;2560;1000;1842.843;333.0195;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1597.278,-307.9736;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1146.136,-55.83489;Float;False;Property;_Main_Power;Main_Power;4;0;Create;True;0;0;False;0;4;4;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;18;-1162.583,-270.8354;Float;True;Property;_Main_Texture;Main_Texture;1;0;Create;True;0;0;False;0;69eea4a9bab8d17439ec9db3891a8c40;69eea4a9bab8d17439ec9db3891a8c40;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;24;-441.2784,-522.9736;Float;False;Property;_Tint_Color;Tint_Color;2;1;[HDR];Create;True;0;0;False;0;1,1,1,1;3.211117,0.6892974,0.6892974,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=866E8481E37E375445FE1DF318A997CE597E0E7F