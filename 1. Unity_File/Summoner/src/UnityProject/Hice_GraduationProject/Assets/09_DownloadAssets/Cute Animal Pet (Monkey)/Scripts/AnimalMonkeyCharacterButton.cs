...
public class AnimalMonkeyCharacterButton : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        ////////////////////////////////////////////////////////////////////
        if (GUI.Button(new Rect(720, 520, 120, 40), "Monkey_1"))
        {
            SceneManager.LoadScene("Monkey_01");
        }

        if (GUI.Button(new Rect(720, 560, 120, 40), "Monkey_2"))
        {
            SceneManager.LoadScene("Monkey_02");
        }

        if (GUI.Button(new Rect(720, 600, 120, 40), "Monkey_3"))
        {
            SceneManager.LoadScene("Monkey_03");
        }
    }
